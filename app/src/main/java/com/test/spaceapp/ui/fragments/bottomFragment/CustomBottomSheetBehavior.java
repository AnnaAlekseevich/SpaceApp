...
public class CustomBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    @CustomBottomSheetBehavior.SaveFlags
    ...
    private CustomBottomSheetBehavior.SettleRunnable settleRunnable = null;
    ...
    @NonNull private final ArrayList<CustomBottomSheetBehavior.BottomSheetCallback> callbacks = new ArrayList<>();
...
//        }
    ...
    public Parcelable onSaveInstanceState(@NonNull CoordinatorLayout parent, @NonNull V child) {
        return new CustomBottomSheetBehavior.SavedState(super.onSaveInstanceState(parent, child), this);
    }
     ...
     */
    public void setSaveFlags(@CustomBottomSheetBehavior.SaveFlags int flags) {
     ...
     *     #removeBottomSheetCallback(CustomBottomSheetBehavior.BottomSheetCallback)} instead
     */
    ...
    public void setBottomSheetCallback(CustomBottomSheetBehavior.BottomSheetCallback callback) {
        Log.w(
                TAG,
                "CustomBottomSheetBehavior now supports multiple callbacks. `setBottomSheetCallback()` removes"
     ...
     * @param callback The callback to notify when bottom sheet events occur.
     */
    public void addBottomSheetCallback(@NonNull CustomBottomSheetBehavior.BottomSheetCallback callback) {
     ...
     */
    public void removeBottomSheetCallback(@NonNull CustomBottomSheetBehavior.BottomSheetCallback callback) {
     ...
     */
    public void setState(@CustomBottomSheetBehavior.State int state) {
        if (state == this.state) {
            return;
        }
        if (viewRef == null) {
    ...
    private void settleToStatePendingLayout(@CustomBottomSheetBehavior.State int state) {
    ...
    private void updateDrawableForTargetState(@CustomBottomSheetBehavior.State int state) {
        if (state == STATE_SETTLING) {
    ...
    private void restoreOptionalState(@NonNull CustomBottomSheetBehavior.SavedState ss) {
    ...
    void startSettlingAnimation(View child, int state, int top, boolean settleFromViewDragHelper) {
        ...
        if (startedSettling) {
            ...
            if (settleRunnable == null) {
                ...
                settleRunnable = new CustomBottomSheetBehavior.SettleRunnable(child, state);
            }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public static final Creator<CustomBottomSheetBehavior.SavedState> CREATOR =
                new ClassLoaderCreator<CustomBottomSheetBehavior.SavedState>() {
                    @NonNull
                    @Override
                    public CustomBottomSheetBehavior.SavedState createFromParcel(@NonNull Parcel in, ClassLoader loader) {
                        return new CustomBottomSheetBehavior.SavedState(in, loader);
                    }

                    @Nullable
                    @Override
                    public CustomBottomSheetBehavior.SavedState createFromParcel(@NonNull Parcel in) {
